                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex flex-col items-end space-x-6">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="font-semibold">01 01 01 00 00</span>
                        </div>
                        <span className="text-xs text-white/80">323 avenue Pierre Jean, 90200</span>
                    </div>
                </div>
            </div>
          ...
          <div className="lg:hidden mt-4 pb-4">
            <div className="flex flex-col items-center space-y-2 mt-4">
              ...
              <div className="mt-4 pt-4 space-y-2">
                ...
                <button className={`flex items-center space-x-2 px-3 py-2  rounded  w-full text-left ${selectedSection === 'inscription' ? 'border-b-4 border-orange-primary' : 'border-b-4 border-transparent'}`}>
